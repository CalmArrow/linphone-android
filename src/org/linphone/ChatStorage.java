...
public class ChatStorage
{
	...
	private boolean isVersionUsingNewChatStorage()
	{
		try
		{
			return context.getPackageManager().getPackageInfo(
					context.getPackageName(), 0).versionCode >= 2200;
	...
	private ChatStorage(Context c)
	{
		...
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(LinphoneService.instance());
		boolean updateNeeded = prefs.getBoolean(
				c.getString(R.string.pref_first_time_linphone_chat_storage),
	...
	public void updateMessageStatus(String to, String message, int status)
	{
		...
		String[] whereArgs =
		{ String.valueOf(OUTGOING), to, message };
	...
	public int saveImageMessage(String from, String to, Bitmap image,
	...
	public void updateDraft(String to, String message)
	{
		...
		db.update(DRAFT_TABLE_NAME, values,
				"remoteContact LIKE \"" + to + "\"", null);
	}
	...
	public String getDraft(String to)
	{
		...
		Cursor c = db.query(DRAFT_TABLE_NAME, null, "remoteContact LIKE \""
				+ to + "\"", null, null, null, "id ASC");
	...
	public List<String> getDrafts()
	{
		...
		{
			Cursor c = db.query(DRAFT_TABLE_NAME, null, null, null, null, null,
					"id ASC");
	...
	public String getTextMessageForId(LinphoneChatRoom chatroom, int id)
	{
		...
		{
			Cursor c = db.query(TABLE_NAME, null, "id LIKE " + id, null, null,
					null, null);
	...
	{
		LinphoneChatRoom chatroom = LinphoneManager.getLc()
	...
	class ChatHelper extends SQLiteOpenHelper
	{
		...
		public void onCreate(SQLiteDatabase db)
		{
			db.execSQL("CREATE TABLE "
					+ TABLE_NAME
					+ " (id INTEGER PRIMARY KEY AUTOINCREMENT, localContact TEXT NOT NULL, remoteContact TEXT NOT NULL, direction INTEGER, message TEXT, image BLOB, url TEXT, time NUMERIC, read INTEGER, status INTEGER);");
			db.execSQL("CREATE TABLE "
					+ DRAFT_TABLE_NAME
					+ " (id INTEGER PRIMARY KEY AUTOINCREMENT, remoteContact TEXT NOT NULL, message TEXT);");
		}
